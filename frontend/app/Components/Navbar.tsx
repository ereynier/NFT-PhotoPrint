...
const Navbar = () => {
    ...
    return (
        <nav ref={ref} className={`w-full bg-white bg-opacity-85 border-gray-200 shadow-md top-0 z-50 navbar sticky ${/*translate*/""} transition-transform duration-300`}>
            <div className="flex flex-wrap items-center justify-between mx-4 lg:mx-20 sm:mx-10 p-2">
                <Link href="/" target='' className="flex flex-col items-start md:w-1/3">
                ...
                <div hidden={hidden} className="w-1/3 md:block" id="navbar-default">
                    <ul className="items-end justify-end font-medium flex flex-col p-4 md:p-0 mt-4 border rounded-lg bg-transparent md:flex-row md:space-x-8 md:mt-0 md:border-0 ">
                        <li>
